...
const DICT = {
  ...
  fr: {
    meta_title:    'Choisissez votre Boîte',
    title:         'Choisissez votre Boîte Cadeau !',
    subtitle:      'Une boîte cache une récompense spéciale',
    hint:          'Appuyez sur une boîte pour révéler ce qu\'il y a dedans',
    try_again:     '❌ Pas celle-là ! Un essai de plus.',
    win_step3:     'Révélation de la dernière boîte…',
    win_title:     'Félicitations !',
    win_desc:      'Votre récompense a été activée',
    reward_text:   '+200% Bonus  •  150 Tours Gratuits',
    timer_label:   'L\'offre expire dans :',
    button_action: 'Réclamer ma Récompense →',
  },
  pl: {
    meta_title:    'Wybierz Pudełko',
    title:         'Wybierz Swoje Pudełko!',
    subtitle:      'W jednym pudełku ukryta jest wyjątkowa nagroda',
    hint:          'Dotknij pudełka, aby odkryć co jest w środku',
    try_again:     '❌ Nie tu! Jeszcze jedna próba.',
    win_step3:     'Otwieramy ostatnie pudełko…',
    win_title:     'Gratulacje!',
    win_desc:      'Twoja nagroda została aktywowana',
    reward_text:   '+200% Bonus  •  150 Darmowych Spinów',
    timer_label:   'Oferta wygasa za:',
    button_action: 'Odbierz Nagrodę →',
  },
  cs: {
    meta_title:    'Vyberte Krabičku',
    title:         'Vyberte si Dárkovou Krabičku!',
    subtitle:      'V jedné krabičce se skrývá speciální odměna',
    hint:          'Klepněte na krabičku a odkryjte, co je uvnitř',
    try_again:     '❌ Tady ne! Ještě jeden pokus.',
    win_step3:     'Otevíráme poslední krabičku…',
    win_title:     'Gratulujeme!',
    win_desc:      'Vaše odměna byla aktivována',
    reward_text:   '+200% Bonus  •  150 Roztočení Zdarma',
    timer_label:   'Nabídka vyprší za:',
    button_action: 'Získat Odměnu →',
  },
  de: {
